        ...
        <ul>
            @foreach($tasks as $task)
                <div class="d-flex flex-row justify-content-around">
                    <div class="p-2">
                        <button class="btn btn-sm rounded-circle btn-warning" wire:click="editTask({{ $task->id }})">
                            edit
                        </button>
                        <button class="btn btn-sm rounded-circle btn-danger" wire:click="deleteTask({{ $task->id }})">
                            delete
                        </button>
                    </div>
                    <div class="p-2">
